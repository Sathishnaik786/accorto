...
export const Route = createFileRoute("/academy/corporate-training")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Empower your engineering teams. Custom corporate AI workshops on Copilot adoption, RAG architectures, and AI governance standards.",
      },
...
const SERVICES = [
  { name: "Generative AI Integration", desc: "Build domain-specific LLM adapters, fine-tuning setups, and secure enterprise ingestion structures." },
  { name: "Copilot & Tool Adoption", desc: "Optimize developer workflows with customized pair-programming agents and productivity metrics." },
  { name: "AI Agents Workflows", desc: "Train cohorts to architect multi-agent autonomous graphs that handle complex back-office tasks." },
  { name: "Process Automation", desc: "Replace fragile script systems with robust AI-driven semantic parsers and classification triggers." },
  { name: "AI Governance & Audits", desc: "Establish model safety guidelines, cost management benchmarks, privacy protocols, and compliance frameworks." },
  { name: "RAG Architectures", desc: "Implement secure retriever-retrieval systems matching legacy databases with modern context engines." },
  { name: "Team Upskilling", desc: "Comprehensive engineering curriculum cycles from basic syntax structures to advanced production MLOps." },
  { name: "Enterprise Workshops", desc: "On-site intensive training modules covering vector databases, MCP protocols, and security guardrails." },
];
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 pb-24">
        ...
        {/* CTA Banner */}
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl glass-strong border border-white/10 shadow-2xl p-10 md:p-12 text-center mt-16 max-w-4xl mx-auto">
            ...
            <div className="relative space-y-4">
              ...
              <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 max-w-xl mx-auto font-medium">
                Discuss timeline options, custom modules, on-site schedules, and licensing options with our principal consultants.
              </p>
