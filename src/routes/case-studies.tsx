  ...
  return (
    <Reveal delay={delay}>
      <div className="h-full">
        <PremiumCard className="group h-full flex flex-col relative rounded-4xl bg-white dark:bg-card border border-slate-100 dark:border-white/5 shadow-md">
          <div className="relative aspect-16/10 rounded-[24px] overflow-hidden m-3 shadow-xs z-10 border border-slate-200/50 dark:border-white/5 bg-slate-100 dark:bg-white/5">
            <img
              ...
              loading="lazy"
              className="h-full w-full object-cover rounded-[24px] brightness-[0.96] contrast-[1.04]"
            />
