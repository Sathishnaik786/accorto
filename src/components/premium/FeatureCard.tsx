  ...
  return (
    ...
    >
      ...
      <div className={cn("flex flex-col gap-4 relative z-10", wide ? "md:flex-1" : "")}>
        {Icon && (
          <div className="inline-grid h-12 w-12 place-items-center rounded-[18px] bg-slate-50 dark:bg-white/5 border border-slate-200/85 dark:border-white/10 text-brand dark:text-brand-3 shadow-[0_0_20px_rgba(16,185,129,0.15)] md:group-hover:scale-105 md:group-hover:border-slate-300 dark:md:group-hover:border-white/20 transition-all duration-800 ease-out">
