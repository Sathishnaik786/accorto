          ...
          return (
            <div key={idx} className="flex-1 flex flex-col items-stretch relative z-10 group">
              ...
              <div className="pl-10 sm:pl-0 flex flex-col items-stretch h-full">
                <GlassPanel className={cn("flex flex-col items-center md:items-center text-left md:text-center gap-3 w-full hover:border-brand-2/40 transition-all duration-300 shadow-md bg-white dark:bg-card border border-slate-200/60 dark:border-white/5", paddings[idx])}>
