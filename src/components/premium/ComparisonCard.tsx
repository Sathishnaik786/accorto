...
export function ComparisonCard({
  ...
  return (
    <div className={cn("bg-slate-50 dark:bg-white/5 border border-slate-200/60 dark:border-white/10 rounded-2xl p-6 flex flex-col gap-4 relative select-none shadow-xs", className)}>
      {title && (
      ...
      <div className="flex items-center justify-between gap-4 mt-2">
        ...
        <div className="shrink-0 flex items-center justify-center h-8 w-8 rounded-full bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-brand shadow-xs">
