...
export function ComparisonCard({
  ...
  return (
    <div className={cn("bg-slate-50 dark:bg-white/5 border border-slate-200/60 dark:border-white/10 rounded-2xl p-4 sm:p-6 flex flex-col gap-4 relative select-none shadow-xs", className)}>
      {title && (
